...
class Supersticky_mcp {
  ...
  public function __construct()
  {
    ...
    $this->_base_qs     = 'C=addons_modules' .AMP .'M=show_module_cp' .AMP .'module=supersticky';
    ...
    $this->_ee->cp->set_breadcrumb($this->_base_url, $this->_ee->lang->line('supersticky_module_name'));
